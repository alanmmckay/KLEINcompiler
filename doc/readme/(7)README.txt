...
-- Final Submission, Project 7:
    ...
    Unfortunately we did not get around to this. We did do some clean and fixes 
    pertaining to areas lacking in the previous stages.
    ...
    -Directory restructuring. The new directory changes will be noted in the 
    project readme.
